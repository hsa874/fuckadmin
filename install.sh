...
echo -e "${RED}                  ~ Tools for Hacking by Hamza Anonime ${NC}"
echo ""
echo -e "${YELLOW} http://technicaldada.in|
https://www.facebook.com/profile.php?id=100027145343450 .in | https://github.com/Anonime7x ${NC} "
echo ""
echo "---------------------------------------------------------------------------------------"
echo ""
...
echo "[✔] Installing ...";
echo "";
git clone https://github.com/Anonime7x/fuckadmin.git "$INSTALL_DIR";
echo "#!/bin/bash
